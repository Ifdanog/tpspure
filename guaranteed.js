document.addEventListener("DOMContentLoaded", () => {
  ...
  const html = `<div class="trust-banner" style="display:flex;flex-direction:row;justify-content:space-between;width:100%;gap:10px;margin-bottom:15px;">
          <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:10px;flex:1;justify-content:space-between;">
            <span style="display:flex;align-items:center;font-size:14px;color:#333;gap:10px">
              <!-- Location Icon -->
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Uploaded to svgrepo.com" width="40" height="40" viewBox="0 0 32 32" xml:space="preserve">
<style type="text/css">
	.linesandangles_een{fill:#004aad;}
</style>
<path class="linesandangles_een" d="M16,8c-2.757,0-5,2.243-5,5s2.243,5,5,5s5-2.243,5-5S18.757,8,16,8z M16,16  c-1.654,0-3-1.346-3-3s1.346-3,3-3s3,1.346,3,3S17.654,16,16,16z M16,6c3.86,0,7,3.14,7,7c0,5.271-4.719,10.256-7.009,12.365  C13.299,22.889,9,17.901,9,13C9,9.14,12.14,6,16,6 M16,4c-4.971,0-9,4.029-9,9c0,8,9,15,9,15s9-6.984,9-15C25,8.029,20.971,4,16,4  L16,4z"/>
</svg>
              <strong style="line-height:16px;">Tracked Shipping on All Orders</strong>
            </span>

            <span style="display:flex;align-items:center;font-size:14px;color:#333;gap:10px">
              <!-- Fast Delivery Icon -->
              <svg xmlns="http://www.w3.org/2000/svg" fill="#004aad" height="40" width="40" viewBox="0 0 422.518 422.518" aria-label="Fast Delivery">
             ...
             <strong style="line-height:16px;">Express Delivery 1-2 Days</strong>
            </span>
            
            <span style="display:flex;align-items:center;font-size:14px;color:#333;gap:10px">
              <!-- Secure Payments Icon -->
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#004aad" height="23" width="25" version="1.1" id="Capa_1" viewBox="0 0 229.5 229.5" xml:space="preserve">
...
<path d="M7 21V11.6C7 11.0399 7 10.7599 7.10899 10.546C7.20487 10.3578 7.35785 10.2048 7.54601 10.109C7.75992 9.99996 8.03995 9.99996 8.6 9.99996H15.4C15.9601 9.99996 16.2401 9.99996 16.454 10.109C16.6422 10.2048 16.7951 10.3578 16.891 10.546C17 10.7599 17 11.0399 17 11.6V21M10 14H14M10 18H14M3 10.4881V19.4C3 19.96 3 20.24 3.10899 20.454C3.20487 20.6421 3.35785 20.7951 3.54601 20.891C3.75992 21 4.03995 21 4.6 21H19.4C19.9601 21 20.2401 21 20.454 20.891C20.6422 20.7951 20.7951 20.6421 20.891 20.454C21 20.24 21 19.96 21 19.4V10.4881C21 9.41436 21 8.87747 20.8368 8.40316C20.6925 7.98371 20.457 7.60148 20.1472 7.28399C19.797 6.92498 19.3174 6.68357 18.3583 6.20075L14.1583 4.08645C13.3671 3.68819 12.9716 3.48905 12.5564 3.41069C12.1887 3.34129 11.8113 3.34129 11.4436 3.41069C11.0284 3.48905 10.6329 3.68818 9.84171 4.08645L5.64171 6.20075C4.6826 6.68357 4.20304 6.92498 3.85275 7.28399C3.54298 7.60148 3.30746 7.98371 3.16317 8.40316C3 8.87747 3 9.41437 3 10.4881Z" stroke="#004aad" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  ...
  if (target) {
    ...
    const observer = new MutationObserver(() => {
      ...
      if (dynamicEl) {
        dynamicEl.insertAdjacentHTML("afterbegin", html);
        observer.disconnect();
      }
    });
...
//                 <title>Delivery Truck Icon</title>the 
